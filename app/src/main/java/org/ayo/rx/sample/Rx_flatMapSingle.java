...
public class Rx_flatMapSingle extends BaseRxDemo {
    ...
    protected void runOk(){
        task = Flowable.create(new FlowableOnSubscribe<List<String>>() {
            ...
            public void subscribe(FlowableEmitter<List<String>> e) throws Exception {
                ...
                .flatMapSingle(new Function<List<String>, Single<String>>() {
                    @Override
                    public Single<String> apply(List<String> s) throws Exception {
                        return Single.just(Strings.fromList(s, "\n", true));
                    }
                })
