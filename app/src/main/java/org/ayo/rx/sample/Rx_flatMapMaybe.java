...
public class Rx_flatMapMaybe extends BaseRxDemo {
    ...
    protected void runOk(){
        task = Flowable.create(new FlowableOnSubscribe<List<String>>() {
            ...
            public void subscribe(FlowableEmitter<List<String>> e) throws Exception {
                ...
                .flatMapMaybe(new Function<List<String>, Maybe<String>>() {
                    @Override
                    public Maybe<String> apply(List<String> s) throws Exception {
                        return Maybe.just(Strings.fromList(s, "\n", true));
                    }
                })
